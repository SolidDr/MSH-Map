# 12 - App Texte & Strings

## Zentrale String-Definitionen
...
// Kategorie-Name:
Text(AppStrings.getCategoryName('playground')); // -> "Spielplatz"

// Altersgruppe:
Text(AppStrings.getAgeRange('3-6')); // -> "Für Kindergartenkinder (3-6 Jahre)"
```
