...
class OcrPreviewScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    var merchantId = 'demo_merchant';
    var merchantName = 'Demo Restaurant';
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          onPressed: () {
            ref.read(uploadControllerProvider.notifier).backToImageSelected();
            context.go('/upload');
          },
        ),
      ),
        ...
        child: Padding(
          ...
          child: ElevatedButton.icon(
            onPressed: result.isEmpty
                ? null
                : () {
                    ref.read(uploadControllerProvider.notifier).saveMenu(
